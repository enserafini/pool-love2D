...
function CrearMesa()
    ...
    mesa.b1.acople:setFriction(0.5) -- Para que las bochas se desaceleren al chocar con la baranda
    ...
    mesa.b2.acople:setFriction(0.5) -- Para que las bochas se desaceleren al chocar con la baranda
    ...
    mesa.b3.acople:setFriction(0.5) -- Para que las bochas se desaceleren al chocar con la baranda
    ...
    mesa.b4.acople:setFriction(0.5) -- Para que las bochas se desaceleren al chocar con la baranda
